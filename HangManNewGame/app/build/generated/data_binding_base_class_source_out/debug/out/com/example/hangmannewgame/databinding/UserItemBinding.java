...
public final class UserItemBinding implements ViewBinding {
  ...
  private UserItemBinding(@NonNull CardView rootView, @NonNull TextView textView,
      @NonNull TextView textViewScores) {
    this.rootView = rootView;
    this.textView = textView;
    this.textViewScores = textViewScores;
  }
  ...
  public static UserItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewScores;
      TextView textViewScores = ViewBindings.findChildViewById(rootView, id);
      if (textViewScores == null) {
        break missingId;
      }

      return new UserItemBinding((CardView) rootView, textView, textViewScores);
    }
